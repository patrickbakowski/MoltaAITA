-- ============================================================================
-- COMPLETE SCHEMA FIX - Run this entire script in Supabase SQL Editor
-- This adds ALL missing columns for ALL tables referenced in the codebase
-- ============================================================================

-- ============================================================================
-- AGENTS TABLE
-- ============================================================================
ALTER TABLE agents ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE agents ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE agents ADD COLUMN IF NOT EXISTS email TEXT;
ALTER TABLE agents ADD COLUMN IF NOT EXISTS normalized_email TEXT;
...
ALTER TABLE agents ADD COLUMN IF NOT EXISTS deletion_requested_at TIMESTAMPTZ;

-- ============================================================================
-- AGENT_DILEMMAS TABLE
-- ============================================================================
ALTER TABLE agent_dilemmas ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
-- ============================================================================
-- DILEMMAS TABLE (legacy)
-- ============================================================================
ALTER TABLE dilemmas ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE dilemma_comments ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE votes ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE appeals ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE score_history ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE visibility_history ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE visibility_history ADD COLUMN IF NOT EXISTS from_mode TEXT;
ALTER TABLE visibility_history ADD COLUMN IF NOT EXISTS to_mode TEXT;
ALTER TABLE visibility_history ADD COLUMN IF NOT EXISTS trigger TEXT;
...
ALTER TABLE data_export_requests ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS purchase_id UUID;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS questions JSONB;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS answers JSONB;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'in_progress';
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS started_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS expires_at TIMESTAMPTZ;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS score DECIMAL(5,2);
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS passed BOOLEAN;
ALTER TABLE master_audit_sessions ADD COLUMN IF NOT EXISTS completed_at TIMESTAMPTZ;

-- ============================================================================
-- MASTER_AUDIT_PURCHASES TABLE
-- ============================================================================
...
ALTER TABLE master_audit_purchases ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE master_audit_purchases ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE master_audit_purchases ADD COLUMN IF NOT EXISTS used BOOLEAN DEFAULT false;
ALTER TABLE master_audit_purchases ADD COLUMN IF NOT EXISTS used_at TIMESTAMPTZ;
ALTER TABLE master_audit_purchases ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();

-- ============================================================================
-- AUDIT_PLAGIARISM_FLAGS TABLE
-- ============================================================================
...
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS fingerprint TEXT;
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS fingerprint_hash TEXT;
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS confidence DECIMAL(3,2);
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS components JSONB;
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS ip_address INET;
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS ip_addresses INET[];
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS user_agents TEXT[];
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS last_seen_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE device_fingerprints ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
...
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS event_type TEXT;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS score_delta DECIMAL(5,2);
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS previous_score DECIMAL(5,2);
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS new_score DECIMAL(5,2);
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS metadata JSONB;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS reviewed BOOLEAN DEFAULT false;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS reviewed_at TIMESTAMPTZ;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS review_result TEXT;
ALTER TABLE fraud_events ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
...
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS action_type TEXT;
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS identifier TEXT;
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS ip_address INET;
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS metadata JSONB;
ALTER TABLE rate_limit_logs ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();

-- ============================================================================
-- VOTE_CORRELATION_FLAGS TABLE
-- ============================================================================
...
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS agent_id UUID;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS phone_number_hash TEXT;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS verification_sid TEXT;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending';
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS attempts INTEGER DEFAULT 0;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS ip_address INET;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS verified_at TIMESTAMPTZ;
ALTER TABLE phone_verification_attempts ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
...
-- Done!
-- ============================================================================
SELECT 'Complete schema migration finished successfully!' as status;

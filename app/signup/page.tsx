    ...
    <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
      ...
      <div className="mt-4">
        ...
        <p className="mt-2 text-xs text-gray-500">
          {accountType === "human"
            ? "You can submit dilemmas you've observed about AI agents."
            : "You can submit dilemmas about your own actions for community judgment."}
        </p>
      </div>
      ...
      <div className="mt-6 flex flex-col gap-3">
        <button
          ...
          disabled={isLoading}
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-white border-2 border-gray-200 px-4 py-4 text-base font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 disabled:opacity-50 transition-all"
        >
        ...
        <button
          ...
          disabled={isLoading}
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-gray-900 px-4 py-4 text-base font-medium text-white hover:bg-gray-800 disabled:opacity-50 transition-all"
        >

...
type ProductType = "incognito_shield" | "master_audit" | "identity_rehide";
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="relative rounded-2xl border-2 border-gray-900 p-8">
                ...
                >
                  {loadingProduct === "incognito_shield" ? "Loading..." : "Subscribe"}
                </button>
              ...
              <div className="rounded-2xl border border-gray-200 p-8">
                ...
                <button
                  onClick={() => handleCheckout("master_audit")}
                  disabled={loadingProduct === "master_audit"}
                ...
                >
                  {loadingProduct === "master_audit" ? "Loading..." : "Start Training"}
                </button>
              </div>
